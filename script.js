...
const togetherSince = "2023-11-23";
...
const quoteStages = [
  [
    ...
    "Nggak semua hari harus terasa spesial buat tetap berarti.",
    "Kadang yang paling berat itu hal kecil yang keliatannya sepele buat orang lain.",
    "Capek itu bukan tanda kamu menyerah, itu tanda kamu udah berusaha keras.",
    "Progres nggak selalu keliatan dari luar. Tapi itu tetap progres.",
    "Nggak semua orang harus paham jalan yang kamu ambil. Cukup kamu yang tahu itu.",
    "Hari yang biasa-biasa aja juga tetap layak disyukuri.",
    "Nggak ada yang salah kalau kamu butuh waktu lebih lama dari orang lain.",
    "Berhenti sebentar bukan berarti kalah. Itu cuma jeda buat lanjut lagi.",
    "Kamu boleh nggak tahu jawabannya sekarang. Nggak semua pertanyaan harus langsung kejawab."
  ],
  [
    ...
    "Nggak semua luka harus buru-buru sembuh. Ada yang emang butuh waktu, dan itu wajar.",
    "Kamu nggak harus punya alasan besar buat berhak istirahat.",
    "Ragu itu manusiawi. Bukan berarti kamu nggak mampu.",
    "Kamu boleh nangis kalau memang itu yang kamu butuh hari ini.",
    "Nggak semua hal harus langsung dimengerti sekarang. Beberapa jawaban datang belakangan.",
    "Apa yang kamu lewatin sekarang, suatu hari bakal jadi bagian dari cerita kamu yang kuat.",
    "Kamu nggak perlu terburu-buru baik-baik aja cuma biar orang lain nyaman.",
    "Setiap kali kamu bangun lagi setelah jatuh, itu udah cukup buat dibanggain."
  ],
  [
    ...
    "Kalau ada hari kamu ngerasa belum sesuai harapan, buat aku kamu tetap orang yang aku banggain.",
    "Aku nggak butuh kamu selalu berhasil buat tetap sayang sama kamu.",
    "Aku nggak keberatan nunggu sabar sampai kamu siap lagi.",
    "Aku tahu kamu udah berusaha, meskipun hasilnya belum sesuai yang kamu mau.",
    "Kamu nggak sendirian ngadepin ini. Ada aku yang bakal terus di samping kamu.",
    "Buat aku, kamu tetap berharga, terlepas dari apapun yang terjadi.",
    "Aku bakal tetap ada, entah kamu lagi di titik terbaik atau lagi struggling.",
    "Nggak peduli seberapa lama kamu butuh waktu, aku tetap nunggu di sini."
  ]
];
...
setInterval(showStoryQuote, 6000);
  ...
  // ---- Musik latar (playlist, biar nggak itu-itu aja) ----
  // Taruh file lagu tambahan di folder yang sama dengan nama persis di bawah ini.
  // song.mp3 udah ada (lagu asli kamu). Tinggal tambahin song2.mp3 s/d song5.mp3.
  const playlist = shuffle(["song.mp3", "song2.mp3", "song3.mp3", "song4.mp3", "song5.mp3"]);
  let trackIndex = 0;
  ...
  const clockTrigger = document.getElementById("clockTime");
  ...
  // Pesan rahasia kedua, muncul dari ketuk jam. Ganti sesuai kata-kata kamu sendiri kalau mau.
  const secretMessage2 =
    "Nanti kalau waktunya udah pas, aku pengen kita rayain semua hal kecil yang udah kita lewatin bareng. Nggak perlu buru-buru, aku sabar nunggu sampai hari itu datang.";

  function openSecret(message) {
    if (!secretOverlay) return;
    if (secretMessageEl) secretMessageEl.textContent = message;
